...
class Gatekeeper
{
    ...
    protected function getNotice(array $noop, array $errors): string
    {
        ...
        $notice = translate_nooped_plural($noop, count($values), 'site-reviews-themes');
    ...
    {
        $noop = _nx_noop('These plugins require the latest version of', 'These plugins require the latest version of:', 'admin-text', 'site-reviews-themes');
    ...
    {
        $noop = _nx_noop('These plugins need an update to work with', 'These plugins need an update to work with:', 'admin-text', 'site-reviews-themes');
        return $this->getNotice($noop, [
            'unsupported_version',
        ]);
    }
