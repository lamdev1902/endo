...
use GeminiLabs\SiteReviews\Addon\Authors\Defaults\DeleteReviewDefaults;
...
class DeleteReviewValidator extends DefaultValidator
{
    public function request(): Request
    {
        $values = glsr(DeleteReviewDefaults::class)->unguardedMerge($this->request->toArray());
    ...
    public function rules(): array
    {
        ...
        $form = new DeleteReviewForm($review, $this->request->toArray());
