<?php defined('ABSPATH') || exit;
    ...
    $files = glsr('site-reviews-filters')->filterArray("documentation/shortcode/{$dir}", $files);
    ksort($files, SORT_NATURAL);
?>
<div class="glsr-card postbox">
    <h3 class="glsr-card-heading">
        <button type="button" class="glsr-accordion-trigger" aria-expanded="false" aria-controls="shortcode-site_reviews_filters">
            <span class="title">Display the review filters</span>
            <span class="badge code">[site_reviews_filters]</span>
            <span class="icon"></span>
        </button>
    </h3>
    <div id="shortcode-site_reviews_filters" class="inside">
