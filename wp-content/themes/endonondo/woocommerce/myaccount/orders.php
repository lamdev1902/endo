...
<?php else : ?>
	...
	<?php wc_print_notice( esc_html__( 'Oops! Nothing found', 'woocommerce' ) . ' <div class="account-shop"><a class="woocommerce-Button wc-forward button' . esc_attr( $wp_button_class ) . '" href="' . esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ) . '">' . esc_html__( 'Shop Now', 'woocommerce' ) . '</a></div>', 'notice' ); // phpcs:ignore WooCommerce.Commenting.CommentHooks.MissingHookComment ?>
