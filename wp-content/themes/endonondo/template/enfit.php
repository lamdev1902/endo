...
<main id="content" class="coming">
    ...
    <section class="third__coming pd-secondary">
        <div class="container">
            ...
            <div class="third__coming--bottom flex">
                ...
                <div class="it">
                    <div>
                        <img class="" src="<?= get_template_directory_uri() . '/assets/images/enfit/third-3.jpg' ?>"
                ...
                <div class="it">
                    <div class="">
                        <img class="" src="<?= get_template_directory_uri() . '/assets/images/enfit/third-4.jpg' ?>"
    ...
    if (!empty($app[0])):
        ...
        $storeLink = get_field('enfit_store', 'option');
        $store = $storeLink ?: '';
        ?>
                    ...
                    <div class="content app-content">
                        ...
                        <?php if (!empty($store)): ?>
                            <div class="mr-bottom-20">
                                <a target="_blank" class="mr-bottom-20" href="<?= $store ?>">
                                    <img src="<?= get_template_directory_uri() . '/assets/images/enfit/store.svg' ?>" alt="">
                                </a>
                            </div>
                        <?php endif; ?>
