              ...
              <div id="pdc-des" class="pdc-item">
                ...
                <div id="pdc-review" class="pdc-item">
                  ...
                  <div class="pdc-review-list">
                    ...
                    <?php echo do_shortcode('[site_reviews theme="34700" assigned_posts="' . $pid . '" filters="sort_by"]'); ?>
                  </div>
                  <div class="pdc-review-form" style="display: none;">
                    ...
                    <div class="pdc-form-box">
                      <?php echo do_shortcode('[site_reviews_form form="34698" assigned_posts="' . $pid . '"]'); ?>
                    </div>
                  </div>
                </div>
              </div>
